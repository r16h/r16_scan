...
class Main:
    ...
    def banner():
        ...
        print(Font.Color.GREEN + text
              +
              Font.Color.WHITE + "| A COMPLETE R16 SCAN:)      " + Font.Color.BANNER + "CODED BY R16 TEAM" + Font.Color.RESET + Font.Color.WHITE + "                      |\n|                                                                   |")
        print(Font.Color.WHITE + "|[+]" + Font.Color.GREEN + "VERSION:" + version +      Font.Color.WHITE +  "\t\t\tCURRENT-DATE: {}".format(Font.Color.GREEN + Date1) + 
              Font.Color.WHITE + "    |")
        print(
            Font.Color.YELLOW + "|Instagram:rabee.ps " + Font.Color.WHITE + "\t\t\tDATE-FORMAT: {}".format(Font.Color.GREEN + Country + Font.Color.YELLOW) + "          \n|Email:*********" + Font.Color.WHITE + "\t\tCLI-LANGUAGE: {}".format(Font.Color.GREEN + Lang + Font.Color.YELLOW) + "       |\n|GitHub:*****                                                      |\n|Twitter:*****                                                 |\n|Linkedin:https://www.linkedin.com/in/Lucksi                        |")
        print(Font.Color.WHITE +
              "---------------------------------------------------------------------")
    ...
    def Mobile_Banner():
        ...
        f.close()
        print(Font.Color.GREEN + text)
        print(Font.Color.WHITE + "A COMPLETE R16 SCAN:)      " +
              Font.Color.BANNER + "CODED BY R16 TEAM" + Font.Color.RESET)
        print(Font.Color.WHITE + "\n[+]" +
              Font.Color.GREEN + "VERSION:" + version)
        print(
            Font.Color.YELLOW + "Instagram:rabee.ps\n")
