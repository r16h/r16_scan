...
class Menu:
    ...
    def CreateTemplate(Template,Content,filename,htmlcontent,username):
        ...
        <body>
         <p>PDF REPORT FOR {} GRAPH</p>
          <div class = "Metadata">
            ...
            <p>PDF GENERATED BY R16 TEAM</p>
            <p>GENERATED ON: {}</p>
            <p>R16 TEAM DOWNLOAD LINK: https://github.com/r16h/r16_scan</p>
           </div>
            <br>
            {}
        </body>
        ...
        choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(langfile, "Transfer", "Question", "None") + Font.Color.GREEN + "[#R16 TEAM#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
